...
type EventResponse_ErrorCode int32

const (
	EventResponse_NONE         EventResponse_ErrorCode = 0
	EventResponse_INVALID_DATA EventResponse_ErrorCode = 1
)

// Enum value maps for EventResponse_ErrorCode.
var (
	EventResponse_ErrorCode_name = map[int32]string{
		0: "NONE",
		1: "INVALID_DATA",
	}
	EventResponse_ErrorCode_value = map[string]int32{
		"NONE":         0,
		"INVALID_DATA": 1,
	}
)

func (x EventResponse_ErrorCode) Enum() *EventResponse_ErrorCode {
	p := new(EventResponse_ErrorCode)
	*p = x
	return p
}

func (x EventResponse_ErrorCode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EventResponse_ErrorCode) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_covidshield_proto_enumTypes[2].Descriptor()
}

func (EventResponse_ErrorCode) Type() protoreflect.EnumType {
	return &file_proto_covidshield_proto_enumTypes[2]
}

func (x EventResponse_ErrorCode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *EventResponse_ErrorCode) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = EventResponse_ErrorCode(num)
	return nil
}

// Deprecated: Use EventResponse_ErrorCode.Descriptor instead.
func (EventResponse_ErrorCode) EnumDescriptor() ([]byte, []int) {
...
type EventRequest struct {
	...
	SafetyNetJwt     *string `protobuf:"bytes,1,opt,name=safety_net_jwt,json=safetyNetJwt" json:"safety_net_jwt,omitempty"`
	DeviceCheckToken *string `protobuf:"bytes,2,opt,name=device_check_token,json=deviceCheckToken" json:"device_check_token,omitempty"`
	Event            *string `protobuf:"bytes,3,opt,name=event" json:"event,omitempty"`
	DeviceType       *string `protobuf:"bytes,4,opt,name=device_type,json=deviceType" json:"device_type,omitempty"`
}
...
func (x *EventRequest) GetSafetyNetJwt() string {
	if x != nil && x.SafetyNetJwt != nil {
		return *x.SafetyNetJwt
	}
	return ""
}

func (x *EventRequest) GetDeviceCheckToken() string {
	if x != nil && x.DeviceCheckToken != nil {
		return *x.DeviceCheckToken
	}
	return ""
}
...
func (x *EventRequest) GetDeviceType() string {
...
// EventResponse is received from the server in response to a
// EventRequest. If the request was successful, error will be NONE.
type EventResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Error *EventResponse_ErrorCode `protobuf:"varint,1,opt,name=error,enum=covidshield.EventResponse_ErrorCode" json:"error,omitempty"`
}
...
func (x *EventResponse) GetError() EventResponse_ErrorCode {
	if x != nil && x.Error != nil {
		return *x.Error
	}
...
var file_proto_covidshield_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x4b, 0x65, 0x79, 0x52, 0x04, 0x6b, 0x65, 0x79, 0x73, 0x22, 0xba, 0x02, 0x0a, 0x1a, 0x54,
	...
	,
	...
	0x69, 0x74, 0x68, 0x6d, 0x4a, 0x04, 0x08, 0x01, 0x10, 0x02, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03,
	0x52, 0x0d, 0x61, 0x70, 0x70, 0x5f, 0x62, 0x75, 0x6e, 0x64, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x52,
	...
	,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x70, 0x6b, 0x67, 0x2f,
...
var file_proto_covidshield_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_proto_covidshield_proto_goTypes = []interface{}{
	...
	(EventResponse_ErrorCode)(0),           // 2: covidshield.EventResponse.ErrorCode
	(*KeyClaimRequest)(nil),                // 3: covidshield.KeyClaimRequest
	(*KeyClaimResponse)(nil),               // 4: covidshield.KeyClaimResponse
	(*EncryptedUploadRequest)(nil),         // 5: covidshield.EncryptedUploadRequest
	(*EncryptedUploadResponse)(nil),        // 6: covidshield.EncryptedUploadResponse
	(*EventRequest)(nil),                   // 7: covidshield.EventRequest
	(*EventResponse)(nil),                  // 8: covidshield.EventResponse
	(*Upload)(nil),                         // 9: covidshield.Upload
	(*TemporaryExposureKeyExport)(nil),     // 10: covidshield.TemporaryExposureKeyExport
	(*SignatureInfo)(nil),                  // 11: covidshield.SignatureInfo
	(*TemporaryExposureKey)(nil),           // 12: covidshield.TemporaryExposureKey
	(*TEKSignatureList)(nil),               // 13: covidshield.TEKSignatureList
	(*TEKSignature)(nil),                   // 14: covidshield.TEKSignature
...
var file_proto_covidshield_proto_depIdxs = []int32{
	...
	15, // 1: covidshield.KeyClaimResponse.remaining_ban_duration:type_name -> google.protobuf.Duration
	1,  // 2: covidshield.EncryptedUploadResponse.error:type_name -> covidshield.EncryptedUploadResponse.ErrorCode
	2,  // 3: covidshield.EventResponse.error:type_name -> covidshield.EventResponse.ErrorCode
	16, // 4: covidshield.Upload.timestamp:type_name -> google.protobuf.Timestamp
	12, // 5: covidshield.Upload.keys:type_name -> covidshield.TemporaryExposureKey
	11, // 6: covidshield.TemporaryExposureKeyExport.signature_infos:type_name -> covidshield.SignatureInfo
	12, // 7: covidshield.TemporaryExposureKeyExport.keys:type_name -> covidshield.TemporaryExposureKey
	14, // 8: covidshield.TEKSignatureList.signatures:type_name -> covidshield.TEKSignature
	11, // 9: covidshield.TEKSignature.signature_info:type_name -> covidshield.SignatureInfo
